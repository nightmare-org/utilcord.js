!function(r, o) {
    "use strict";
    var e, l = "hljs-ln", s = "hljs-ln-line", f = "hljs-ln-code", c = "hljs-ln-numbers", u = "hljs-ln-n", h = "data-line-number", n = /\r\n|\r|\n/g;
    function t(e) {
        ...
        if (e == o)
            return n;
        var a, i = t.textContent, l = r.textContent;
        for (o < e && (a = e,
        e = o,
        o = a,
        a = i,
        ...
        l = a); 0 !== n.indexOf(i); )
            i = i.slice(1);
        for (; -1 === n.lastIndexOf(l); )
            l = l.slice(0, -1);
        for (var s = i, c = function(e) {
    ...
    function a(e) {
        try {
            var n, t = o.querySelectorAll("code.hljs,code.nohighlight");
            for (n in t)
                !t.hasOwnProperty(n) || t[n].classList.contains("nohljsln") || i(t[n], e)
        } catch (e) {
    ...
    function d(e, n) {
        var n = {
          ...
          , e = (!function e(n) {
            var t = n.childNodes;
            for (var r in t)
                !t.hasOwnProperty(r) || 0 < p((r = t[r]).textContent) && (0 < r.childNodes.length ? e(r) : m(r.parentNode))
        }(e),
        e.innerHTML)
          , t = n
          , r = g(e);
        if ("" === r[r.length - 1].trim() && r.pop(),
        1 < r.length || t.singleLine) {
            for (var o = "", a = 0, i = r.length; a < i; a++)
                o += v('<tr><td class="{0} {1}" {3}="{5}"></td><td class="{0} {4}" {3}="{5}">{6}</td></tr>', [s, c, u, h, f, a + t.startFrom, 0 < r[a].length ? r[a] : " "]);
    ...
    r.hljs ? (r.hljs.initLineNumbersOnLoad = function(e) {
        "interactive" === o.readyState || "complete" === o.readyState ? a(e) : r.addEventListener("DOMContentLoaded", function() {
            a(e)
        })
    }
    ,
    ...
    r.hljs.lineNumbersValue = function(e, n) {
        var t;
        if ("string" == typeof e)
            return (t = document.createElement("code")).innerHTML = e,
            d(t, n)
    }
    ,
    ...
    document.addEventListener("copy", function(e) {
        ...
        }(n.anchorNode) || (n = -1 !== window.navigator.userAgent.indexOf("Edge") ? t(n) : n.toString(),
