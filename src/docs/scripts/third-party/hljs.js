var hljs = function() {
    ...
    class T {
        ...
        openNode(n) {
            if (a(n)) {
                let e = n.kind;
                e = n.sublanguage ? "language-" + e : ((e,{prefix: n})=>{
                    if (e.includes(".")) {
                        const t = e.split(".");
    ...
    class i {
        ...
        static _walk(n, e) {
            return "string" == typeof e ? n.addText(e) : e.children && (n.openNode(e),
    ...
    function d(...e) {
        var n, t = "object" == typeof (n = (t = e)[t.length - 1]) && n.constructor === Object ? (t.splice(t.length - 1, 1),
        n) : {};
    ...
    function g(e, {joinWith: n}) {
        ...
        return e.map(e=>{
            ...
            for (; 0 < t.length; ) {
                ...
                "\\" === i[0][0] && i[1] ? a += "\\" + String(Number(i[1]) + n) : (a += i[0],
                "(" === i[0] && r++)
            }
            return a
        }
    ...
    function r(e, n, t={}) {
        ...
        e = d("I", "a", "is", "so", "us", "to", "at", "if", "in", "it", "on", /[A-Za-z]+['](d|ve|re|ll|t|s|n)/, /[A-Za-z]+[-][a-z]+/, /[A-Za-z][a-z]{2,}/),
        a.contains.push({
            begin: O(/[ ]+/, "(", e, /[.]?[:]?([.][ ]|[ ])/, "){3}")
        }),
        a
    ...
    var e = "[a-zA-Z]\\w*"
      ...
      , y = Object.freeze({
        ...
        SHEBANG: (e={})=>{
            var n = /^#![ ]*\//;
            return e.binary && (e.begin = O(n, /.*\b/, e.binary, /\b.*/)),
            l({
                scope: "meta",
                begin: n,
                end: /$/,
    ...
    function _(n, t, e=W) {
        ...
        return "string" == typeof n ? i(e, n.split(" ")) : Array.isArray(n) ? i(e, n) : Object.keys(n).forEach(function(e) {
    ...
    const N = {}
      ...
      , A = (e,n)=>{
        N[e + "/" + n] || (console.log(`Deprecated as of ${e}. ` + n),
        N[e + "/" + n] = !0)
    }
      , S = new Error;
    ...
    function q(e) {
        (n = e).scope && "object" == typeof n.scope && null !== n.scope && (n.beginScope = n.scope,
        delete n.scope),
    ...
    function Q(r) {
        ...
        if (r.compilerExtensions || (r.compilerExtensions = []),
        r.contains && r.contains.includes("self"))
            throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");
        return r.classNameAliases = l(r.classNameAliases || {}),
        function n(t, a) {
            const i = t;
            if (!t.isCompiled) {
                ...
                t.isCompiled = !0;
                let e = null;
                "object" == typeof t.keywords && t.keywords.$pattern && (t.keywords = Object.assign({}, t.keywords),
                ...
                a && (t.begin || (t.begin = /\B|\b/),
                i.beginRe = s(t.begin),
                t.end || t.endsWithParent || (t.end = /\B|\b/),
                t.end && (i.endRe = s(t.end)),
                i.terminatorEnd = c(t.end) || "",
                t.endsWithParent && a.terminatorEnd && (i.terminatorEnd += (t.end ? "|" : "") + a.terminatorEnd)),
                ...
                t.contains = [].concat(...t.contains.map(function(e) {
                    ...
                    n.cachedVariants || (function e(n) {
                        return !!n && (n.endsWithParent || e(n.starts))
                    }(n) ? l(n, {
                        starts: n.starts ? l(n.starts) : null
                    }) : Object.isFrozen(n) ? l(n) : n)
                })),
    ...
    m = function(a) {
        ...
        function l(e, n, t, a) {
            ...
            t = n.ignoreIllegals,
            r = n.language,
            a = void 0) : (A("10.7.0", "highlight(lang, code, ...args) has been deprecated."),
            A("10.7.0", "Please use highlight(code, options) instead.\nhttps://github.com/highlightjs/highlight.js/issues/2277"),
            r = e,
            i = n),
            void 0 === t && (t = !0);
            e = {
        ...
        function B(r, s, o, e) {
            ...
            function c() {
                if (m.keywords) {
                    let e = 0
                      , n = (m.keywordPatternRe.lastIndex = 0,
                    ...
                    for (; n; ) {
                        ...
                        if (i) {
                            ...
                            l[a] = (l[a] || 0) + 1,
                            l[a] <= 7 && (w += s),
                            r.startsWith("_") ? t += n[0] : (i = p.classNameAliases[r] || r,
                            E.addKeyword(n[0], i))
                        } else
                            t += n[0];
                ...
                (null != m.subLanguage ? function() {
                    if ("" !== v) {
                        ...
                        if ("string" == typeof m.subLanguage) {
                            ...
                            e = T(v, m.subLanguage.length ? m.subLanguage : null);
            ...
            function i(e, n) {
                ...
                for (; void 0 !== n[t]; ) {
                    var a, i;
                    e._emit[t] ? (a = p.classNameAliases[e[t]] || e[t],
                    i = n[t],
                    a ? E.addKeyword(i, a) : (v = i,
                    c(),
                    v = ""),
                    t++) : t++
                }
            ...
            function u(e, n) {
                ...
                e.beginScope && (e.beginScope._wrap ? (E.addKeyword(v, p.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
                v = "") : e.beginScope._multi && (i(e.beginScope, n),
                v = "")),
                m = Object.create(e, {
                    parent: {
                        value: m
            ...
            function g(e) {
                var n, t = e[0], a = e.rule, i = new D(a);
                for (const r of [a.__beforeBegin, a["on:begin"]])
                    if (r && (r(e, i),
                    i.isMatchIgnored))
                        return n = t,
                        0 === m.matcher.regexIndex ? (v += n[0],
                        1) : (N = !0,
                        0);
            ...
            function b(e) {
                var n = e[0]
                  ...
                  , a = function e(n, t, a) {
                    ...
                    if (n.endsWithParent)
                        return e(n.parent, t, a)
                }(m, e, t);
                if (!a)
                    return J;
                t = m;
                for (m.endScope && m.endScope._wrap ? (d(),
                E.addKeyword(n, m.endScope._wrap)) : m.endScope && m.endScope._multi ? (d(),
                i(m.endScope, e)) : t.skip ? v += n : (t.returnEnd || t.excludeEnd || (v += n),
                d(),
                t.excludeEnd && (v = n)); m.scope && !m.isMultiClass && E.closeNode(),
                m.skip || m.subLanguage || (w += m.relevance),
                (m = m.parent) !== a.parent; )
                    ;
                return a.starts && u(a.starts, e),
                t.returnEnd ? 0 : n.length
            }
            let h = {};
            function n(e, n) {
                var t = n && n[0];
                ...
                if ("begin" === h.type && "end" === n.type && h.index === n.index && "" === t) {
                    if (v += s.slice(n.index, n.index + 1),
                    S)
                        return 1;
                    {
                        const a = new Error(`0 width match regex (${r})`);
                        throw a.languageName = r,
                        a.badRule = h.rule,
                        a
                    }
                }
        ...
        function T(n, e) {
            ...
            const a = e.filter(I).filter(d).map(e=>B(e, n, !1));
            a.unshift(t);
            var [e,t] = a.sort((e,n)=>{
                if (e.relevance !== n.relevance)
                    return n.relevance - e.relevance;
                if (e.language && n.language) {
                    if (I(e.language).supersetOf === n.language)
                        return 1;
                    if (I(n.language).supersetOf === e.language)
                        return -1
                }
                return 0
            }
        ...
        function n(e) {
            var n, t, a, i = function(e) {
                ...
                var t, a = R.languageDetectRe.exec(n);
                return a ? ((t = I(a[1])) || (x(M.replace("{}", a[1])),
                x("Falling back to no-highlight mode for this block.", e)),
                t ? a[1] : "no-highlight") : n.split(/\s+/).find(e=>o(e) || I(e))
            }(e);
            o(i) || (u("before:highlightElement", {
                el: e,
                language: i
            }),
            !R.ignoreUnescapedHTML && 0 < e.children.length && (console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),
        ...
        Object.assign(a, {
            ...
            highlightBlock: function(e) {
                return A("10.7.0", "highlightBlock will be removed entirely in v12.0"),
            ...
            initHighlighting: ()=>{
                e(),
                A("10.6.0", "initHighlighting() deprecated.  Use highlightAll() now.")
            }
            ,
            initHighlightingOnLoad: function() {
                e(),
                A("10.6.0", "initHighlightingOnLoad() deprecated.  Use highlightAll() now.")
            },
            ...
            addPlugin: function(e) {
                var n;
                (n = e)["before:highlightBlock"] && !n["before:highlightElement"] && (n["before:highlightElement"] = e=>{
                    n["before:highlightBlock"](Object.assign({
                        block: e.el
                    }, e))
                }
                ),
                n["after:highlightBlock"] && !n["after:highlightElement"] && (n["after:highlightElement"] = e=>{
                    n["after:highlightBlock"](Object.assign({
                        block: e.el
                    }, e))
                }
                ),
        ...
        for (const g in y)
            "object" == typeof y[g] && z(y[g]);
        return Object.assign(a, y),
        a
    }({});
    const V = ["a", "abbr", "address", "article", "aside", "audio", "b", "blockquote", "body", "button", "canvas", "caption", "cite", "code", "dd", "del", "details", "dfn", "div", "dl", "dt", "em", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "html", "i", "iframe", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "mark", "menu", "nav", "object", "ol", "p", "q", "quote", "samp", "section", "span", "strong", "summary", "sup", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "time", "tr", "ul", "var", "video"]
    ...
    const R = "[A-Za-z$_][0-9A-Za-z$_]*"
      ...
      , re = ["Intl", "DataView", "Number", "Math", "Date", "String", "RegExp", "Object", "Function", "Boolean", "Error", "Symbol", "Set", "Map", "WeakSet", "WeakMap", "Proxy", "Reflect", "JSON", "Promise", "Float64Array", "Int16Array", "Int32Array", "Int8Array", "Uint16Array", "Uint32Array", "Float32Array", "Array", "Uint8Array", "Uint8ClampedArray", "ArrayBuffer", "BigInt64Array", "BigUint64Array", "BigInt"]
      , se = ["EvalError", "InternalError", "RangeError", "ReferenceError", "SyntaxError", "TypeError", "URIError"]
      , oe = ["setInterval", "setTimeout", "clearInterval", "clearTimeout", "require", "exports", "eval", "isFinite", "isNaN", "parseFloat", "parseInt", "decodeURI", "decodeURIComponent", "encodeURI", "encodeURIComponent", "escape", "unescape"]
    ...
    function de(e) {
        ...
        return {
            ...
            }, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, d, c, g, b, l, v, {
                className: "attr",
                begin: n + k(":"),
                relevance: 0
            }, A, {
    ...
    v = d(/[a-zA-Z_]/, /[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/, /[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/, /[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/, /[\u1E00-\u1FFF]/, /[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/, /[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/, /[\u2C00-\u2DFF\u2E80-\u2FFF]/, /[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/, /[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/, /[\uFE47-\uFEFE\uFF00-\uFFFD]/),
    w = d(v, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),
    o = O(v, w, "*");
    O(/[A-Z]/, w, "*"),
    ...
    var ge = Object.freeze({
        ...
        grmr_bash: function(e) {
            ...
            return {
                ...
                contains: [s, e.SHEBANG(), o, r, e.HASH_COMMENT_MODE, t, i, {
                    className: "",
                    begin: /\\"/
                }, {
                    className: "string",
