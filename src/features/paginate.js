...
class Pagination {
     ...
     * @example
     * const { Paginate } = require('utilcord.js');
    ...
    /**
     * @param {Object} emojis for the buttons
     * * `first` - first page emoji (default: ⏮)
     * * `back` - back page emoji (default: ◀)
     * * `next` - next page emoji (default: ▶)
     * * `last` - last page emoji (default: ⏭)
     ...
     ** `setStyle` - set the style of the buttons
     ** `setTime` - set the time of the pagination
     ** `setEmojis` - set the emojis of the buttons
